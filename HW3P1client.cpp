...
{ 
  ...
  catch(llist::OutOfRange){cout << "Sorry, it is out of range" << endl;}
  ...
  cout << "***" << c << endl; c++;
  L2.deleteIth(1, x);
  cout << "Element " << x << " was removed" << endl;
...
void caseThree()
{
  ...
  cout << "***" << 1 << endl;
  try {L3.addbeforeIth(0, 4);}
  catch (llist::OutOfRange){cout << "Sorry, it is out of range" << endl;}

  //2.delete front . error (underflow)
  cout << "***" << 2 << endl;
  try {L3.deleteFront(x);}
  catch (llist::Underflow){cout<< "Sorry, it is empty" << endl;}
}   //end of case 3
...
//PURPOSE of the Program: This program will create a llist
//Algorithm/Design: 4 test cases are divided into 3 functions and each function will do something to the llist. The user will choose one of the 4 test cases until he or she chooses zero to quit the program
int main()
{
